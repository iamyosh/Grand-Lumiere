...
    const mainBookingContainer = document.querySelector('.seatbooking-container'); 
...
const currentShowtimeId = 'woY7OSArG31Da7Omsng3'; 
...
function renderSeats(seatsData) {
    ...
    allSeatCheckboxes.forEach(checkbox => {
        ...
        const seatData = seatsData[seatName]; 
...
function handleCheckboxChange(event) {
    ...
    console.log("Current selected seats:", Array.from(selectedSeats)); 
